...
namespace MvcMaps
{
    ...
    public class GoogleMap : Map<GoogleMap>
    {
            ...
            : base(helper, mapID, "MvcMaps.GoogleMap")
        {
            ...
            this.ScriptInclude("main", "http://maps.google.com/maps?file=api&v=2&key=ABQIAAAAB02y8lF6cBk8AjbrJk0ISxQ6-9oJRf-Ib1VNSZsT4QL_Dhq6ohS1FpVo9YaXN7hSrvKEcbwGu8FVPQ&sensor=false");
