ALTER TABLE BetaSignups DROP COLUMN Created;
ALTER TABLE Stores DROP COLUMN Created;
ALTER TABLE StoreItems DROP COLUMN Created;
ALTER TABLE OpenIDs DROP COLUMN Created;
...
ALTER TABLE ShoppingLists DROP COLUMN 
    Created,
    LastUpdated;
